...
library(rmgarch)
library(nlme)
data <- read.csv("C:/Users/jagad/Downloads/Euro Phases/EURO_NEUTRAL_Rinput.csv") #use min 500 datapoints
a=dim(data)
n=a[2]
...
#print(m)
#}
write.csv(simreturns,"C:/Users/jagad/Downloads/Euro_Neutral_FinalsOut.csv")